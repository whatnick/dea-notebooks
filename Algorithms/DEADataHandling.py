...
def load_sentinel(dc, product, filter_cloud=False, bands_of_interest=None, **query):
    ...
    if bands_of_interest:
        ds = dc.load(product=product, measurements=bands_of_interest, output_crs='EPSG:3577', resolution= (-10, 10), group_by='solar_day', **query)

        print('made it this far, GM is the problem')
