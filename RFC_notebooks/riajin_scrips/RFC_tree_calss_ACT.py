...
train_shps = ['/g/data/u46/users/ck9738/Random_forest/raw_data/train_trees/trees_train.shp']

# Output path for classified geotiff
classification_output = "output_data/classification_act_treetypes.tif"
